...
### Phase 1: Foundation (Tuần 1) — "Xương sống"
...
### Phase 2: Memory & State (Tuần 2) — "Trí nhớ"
...
### Phase 3: Tools & RAG (Tuần 3) — "Hành động"
...
### Phase 4: Supervisor Agent (Tuần 4) — "Đạo diễn"
...
### Phase 5: Safety & Multi-NPC (Tuần 5) — "An toàn & Mở rộng"
...
### Phase 6: Frontend & Polish (Tuần 6) — "Trải nghiệm"
...
```
Sprint 1-2  (Tuần 1):   FOUNDATION + MEMORY
────────────────────────────────────────────────
...
Sprint 5    (Tuần 4):  SAFETY & MULTI-NPC
────────────────────────────────────────────────
...
Sprint 6    (Tuần 5): FRONTEND & POLISH
────────────────────────────────────────────────
